...
export default function ChatPanel({ setActiveNode, datasetId }) {
    ...
    const sendMessage = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE}/chat`, {
                ...
                body: JSON.stringify({ message: userText, dataset_id: datasetId || null })
            });
    ...
    return (
        <>
            ...
            {!open && (
                <div onClick={() => setOpen(true)} style={styles.floatBtn}>💬</div>
            )}
                    ...
                    >
                        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                            ...
                            <div>
                                ...
                                <div
                                    className="daisy-status"
                                    style={{ fontSize: "9px", color: "rgba(0,245,212,0.6)", letterSpacing: "1px" }}
                                >
                                    ONLINE
                                </div>
                            </div>
                                ...
                                <div
                                    style={{
                                        ...
                                        background: msg.sender === "user"
                                            ? "linear-gradient(135deg, rgba(0,245,212,0.18), rgba(0,194,255,0.12))"
